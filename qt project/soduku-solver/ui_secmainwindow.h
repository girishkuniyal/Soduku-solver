...
public:
    ...
    void setupUi(QMainWindow *secMainWindow)
    {
        if (secMainWindow->objectName().isEmpty())
            secMainWindow->setObjectName(QString::fromUtf8("secMainWindow"));
        secMainWindow->resize(565, 498);
        QFont font;
        font.setFamily(QString::fromUtf8("Garuda"));
        font.setBold(true);
        font.setWeight(75);
    ...
    {
        secMainWindow->setWindowTitle(QApplication::translate("secMainWindow", "Soduku Solver", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("secMainWindow", "Soduku Solver", 0, QApplication::UnicodeUTF8));
        label_5->setText(QApplication::translate("secMainWindow", "TextLabel", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("secMainWindow", "V 1.0", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("secMainWindow", "Enter Soduku Matrix of 6x6 order", 0, QApplication::UnicodeUTF8));
        pushButton->setText(QApplication::translate("secMainWindow", "Run the Solver", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
